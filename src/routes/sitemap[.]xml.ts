    ...
    handlers: {
      GET: async () => {
        ...
        const entries: SitemapEntry[] = [
          ...
          ...(sweepstakesEnabled ? [{ path: "/ruleta", changefreq: "daily", priority: "0.9" },] : []),
          ...
          ...(sweepstakesEnabled ? [{ path: "/historial", changefreq: "daily", priority: "0.7" },] : []),
          ...(sweepstakesEnabled ? [{ path: "/sweepstakes-rules", changefreq: "yearly", priority: "0.4" },] : []),
