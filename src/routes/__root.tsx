...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "ZENDA" },
      { name: "description", content: "Zenda is a mobile-first web app for discovering gourmet cookies and subscribing to monthly deliveries." },
      { name: "author", content: "Lovable" },
      { property: "og:title", content: "ZENDA" },
      { property: "og:description", content: "Zenda is a mobile-first web app for discovering gourmet cookies and subscribing to monthly deliveries." },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary" },
      { name: "twitter:site", content: "@Lovable" },
      { name: "twitter:title", content: "ZENDA" },
      { name: "twitter:description", content: "Zenda is a mobile-first web app for discovering gourmet cookies and subscribing to monthly deliveries." },
