...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "OriGen" },
      { name: "description", content: "OriGen is a mobile-first web app for discovering gourmet cookies and subscribing to monthly deliveries." },
      { name: "author", content: "Lovable" },
      { property: "og:title", content: "OriGen" },
      { property: "og:description", content: "OriGen is a mobile-first web app for discovering gourmet cookies and subscribing to monthly deliveries." },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary" },
      { name: "twitter:site", content: "@Lovable" },
      { name: "twitter:title", content: "OriGen" },
      { name: "twitter:description", content: "OriGen is a mobile-first web app for discovering gourmet cookies and subscribing to monthly deliveries." },
    ...
    links: [
      ...
      {
        rel: "stylesheet",
        href: "https://fonts.googleapis.com/css2?family=Cinzel:wght@500;600;700&family=Cormorant+Garamond:ital,wght@1,400;1,500&display=swap",
      },
    ],
  }),
