...
import i18n, { syncClientLanguage } from "@/i18n";
...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "OyS" },
      { name: "description", content: "Oys is a mobile-first web app for discovering gourmet cookies and subscribing to monthly deliveries." },
      { name: "author", content: "Lovable" },
      { property: "og:title", content: "OyS" },
      { property: "og:description", content: "Oys is a mobile-first web app for discovering gourmet cookies and subscribing to monthly deliveries." },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary" },
      { name: "twitter:site", content: "@Lovable" },
      { name: "twitter:title", content: "OyS" },
      { name: "twitter:description", content: "Oys is a mobile-first web app for discovering gourmet cookies and subscribing to monthly deliveries." },
